...
function Numbering(nums, abstractNums, styles) {
    ...
    function findLevels(numId) {
        return findLevelsWithSeenNumIds(numId, Object.create(null));
    }

    function findLevelsWithSeenNumIds(numId, seenNumIds) {
        if (seenNumIds[numId]) {
            return null;
        }
        seenNumIds[numId] = true;
        ...
        if (!abstractNum) {
            ...
            return abstractNum.levels;
        } else {
            var style = styles.findNumberingStyleById(abstractNum.numStyleLink);
            return findLevelsWithSeenNumIds(style.numId, seenNumIds);
        }
    }
