...
function readOptions(options) {
    ...
    return _.extend({}, standardOptions, options, {
        ...
        numberingClassMap: readNumberingClassMap(options.numberingClassMap),
...
function readNumberingClassMap(numberingClassMap) {
    if (!numberingClassMap) {
        return [];
    }

    return numberingClassMap.map(function(mapping) {
        return {
            numFmt: mapping.numFmt,
