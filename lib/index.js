...
var nonListNumbering = require("./non-list-numbering");
...
function convertDocumentToHtml(documentResult, options) {
    ...
    return documentResult.flatMapThen(function(document) {
        return styleMapResult.flatMapThen(function(styleMap) {
            var normalisedDocument = nonListNumbering.normalise(document, styleMap);
            return documentConverter.convertToHtml(normalisedDocument);
        });
    });
}
